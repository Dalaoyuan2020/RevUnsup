...
extern "C" _declspec(dllexport) int creatModel(int modelIndex, const char* modelRootDir)
{
...
int main(int argc, char **argv)
{
	...
	int useCudasymbol = 1;
	char* cpuModel = "E:\\SVN\\XAlogrithm_Develop\\bin\\Debug\\Model\\202503211511237808";
	int ret = creatModel(0, cpuModel);
	cout << "ret: " << ret << endl;
	cpuModel = "E:\\SVN\\XAlogrithm_Develop\\bin\\Debug\\Model\\202503211511237808\\model";
	ret = creatModel(0, cpuModel);
	cout << "ret: " << ret << endl;

	char* imgname = "E:\\SVN\\XAlogrithm_Develop\\bin\\Debug\\mat.jpg";
