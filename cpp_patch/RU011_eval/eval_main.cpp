// RU-011: ChipROI02 evaluation harness using L0-v2 DLL
#include <iostream>
#include <chrono>
#include <string>
#include <vector>
...
int main() {
    std::cout << "=== RU-011 ChipROI02 Evaluation ===" << std::endl;

    // 1. Init model (ChipROI02 trained model)
    // NOTE: New ChipROI02 model crashes during inference (0xC0000409).
    // Fallback to old model for pipeline verification. See exp_011 report.
    // const char* modelDir = "D:\\RevUnsup\\cpp_patch\\RU011_train_output\\Model";
    ...
    std::string baseDir = "D:\\RevUnsup\\cpp_patch\\RU011_eval\\test_images\\";
